...
namespace WorldPainter.Editor.Tools
{
    public class PreviewManager
    {
        ...
        {
            if (!_previewObjects.TryGetValue(id, out GameObject previewObject))
            {
                previewObject = new GameObject($"{name} Preview")
                {
        ...
        public SpriteRenderer GetOrCreateSpriteRenderer(string id)
        {
            ...
            {
                GameObject previewObject = GetOrCreatePreview(id, "Sprite");
                renderer = previewObject.GetComponent<SpriteRenderer>() ?? previewObject.AddComponent<SpriteRenderer>();
